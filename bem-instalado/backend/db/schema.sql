...
CREATE TABLE IF NOT EXISTS budgets (
  ...
  roll_area NUMERIC(10, 2) NOT NULL DEFAULT 4.5,
  ...
  removal_rolls INTEGER DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS service_requests (
  ...
  expires_at TIMESTAMP NOT NULL DEFAULT (CURRENT_TIMESTAMP + INTERVAL '15 days'),
...
ALTER TABLE service_requests ADD COLUMN IF NOT EXISTS expires_at TIMESTAMP DEFAULT (CURRENT_TIMESTAMP + INTERVAL '15 days');
...
ALTER TABLE budgets ADD COLUMN IF NOT EXISTS roll_area NUMERIC(10, 2) NOT NULL DEFAULT 4.5;
...
ALTER TABLE clients ADD COLUMN IF NOT EXISTS client_type VARCHAR(20) NOT NULL DEFAULT 'person';
ALTER TABLE clients ADD COLUMN IF NOT EXISTS document_id VARCHAR(30);
