...
const privacySections = [
  ...
  ['3. Compartilhamento', 'Serviço, medidas, fotos e região aproximada são exibidos a instaladores elegíveis para que decidam se desejam atender. Telefone, e-mail, endereço completo e referência são liberados somente ao instalador escolhido pelo cliente. Também podemos usar provedores de hospedagem, banco de dados, e-mail e armazenamento, limitados à operação do serviço.'],
